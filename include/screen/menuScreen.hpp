...
public:
    ...
    void createAndAddButtonToScreen(const std::string &fileTexture, const std::string &buttonText = "", float xPos = 0, float yPos = 0, float xSize = 0, float ySize = 0, float scale = 1, std::shared_ptr<EventBus> bus = nullptr);
};