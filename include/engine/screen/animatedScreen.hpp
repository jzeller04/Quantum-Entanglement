...
public:
    AnimatedScreen(SCREEN_LABEL label = SCREEN_LABEL::NO_LABEL, const std::string filePth = "", float frameTime = 2.0f, std::shared_ptr<sf::RenderWindow> window = nullptr, std::shared_ptr<EventBus> eventBus = nullptr);
